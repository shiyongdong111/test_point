...
public class email2 {
    ...
    public static void main(String[] args) throws MessagingException, GeneralSecurityException {
        ...
        //3.连接服务器,需要抛出异常；
        tp.connect("smtp.qq.com","","qbzyqehrxepndcge");
    ...
    public static MimeMessage imageMail(Session session) throws MessagingException {
        ...
        //邮件发送人
        mimeMessage.setFrom(new InternetAddress("2817810975@qq.com"));


        /*
        * 邮件接收人，可以同时发送给很多人，我们这里只发给自己；
        * */
        mimeMessage.setRecipient(Message.RecipientType.TO, new InternetAddress("1220377922@qq.com"));
        mimeMessage.setSubject("性感北鼻"); //邮件主题
        ...
        body1.setDataHandler(new DataHandler(new FileDataSource("src/main/resources/1.jpg")));
        body1.setContentID("1.jpg"); //图片设置ID

        //文本
        MimeBodyPart body2 = new MimeBodyPart();
        for (int i = 0; i < 5; i++) {
            body2.setContent("请注意，我不是广告,请仔细观看长腿美女<img src='cid:1.jpg'>","text/html;charset=utf-8");
        }
